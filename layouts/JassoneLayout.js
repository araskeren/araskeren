...
const JassoneLayout = ({ darkLogo = true }) => {
  ...
  useEffect(() => {
    ...
    setAboutData({
      img: "/img/hero/7.jpg",
      name: "Damis Bachtiar",
      email: "damisbachtiar@gmail.com",
      bio: "Hi, I'm Damis Bachtiar. Software Engineer, I am very passionate and dedicated to my work. With 3 years experience as a software developer, I have acquired the skills and knowledge necessary to make your project a success.",
    });
  }, []);
